...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return CodeGraphStatement.internal_static_security_sast_codegraph_repopb_SetField_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return CodeGraphStatement.internal_static_security_sast_codegraph_repopb_SetField_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            SetField.class, SetField.Builder.class);
  }
  ...
  public static SetField parseFrom(
  ...
  public static SetField parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static SetField parseFrom(
  ...
  public static SetField parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static SetField parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static SetField parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(SetField prototype) {
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public SetField getDefaultInstanceForType() {
      return SetField.getDefaultInstance();
    }

    @java.lang.Override
    public SetField build() {
      SetField result = buildPartial();
    ...
    @java.lang.Override
    public SetField buildPartial() {
      SetField result = new SetField(this);
    ...
    private void buildPartial0(SetField result) {
    ...
    private void buildPartialOneofs(SetField result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof SetField) {
        return mergeFrom((SetField)other);
      } else {
    ...
    public Builder mergeFrom(SetField other) {
      if (other == SetField.getDefaultInstance()) return this;
  ...
  private static final SetField DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new SetField();
  }

  public static SetField getDefaultInstance() {
